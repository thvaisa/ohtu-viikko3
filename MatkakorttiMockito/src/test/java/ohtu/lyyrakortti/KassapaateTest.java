...
public class KassapaateTest {
    ...
    @Test
    public void kortilleLataaminenValidiInput(){
        when(kortti.getSaldo()).thenReturn(99);
        kassa.lataa(kortti, 99);
        verify(kortti, times(1)).lataa(99);
    }
    
        
    @Test
    public void kortilleLataaminenInvalidiInput(){
        when(kortti.getSaldo()).thenReturn(-99);
        kassa.lataa(kortti, -99);
